...
public class TestAccionPreguntar {
	...
	public void testHayGasVespeno(){
		...
		mapa.colocarObjeto(posMapa, new RecursoGasVespeno(1000));
	...
	public void testHayMineral(){
		...
		mapa.colocarObjeto(posMapa, new RecursoMineral(1000));
	...
	public void testHayEdificio(){
		...
		mapa.colocarObjeto(posMapa, new EdificioBarraca(new RecursosDelJugador(1000,1000), new Suministro()));
