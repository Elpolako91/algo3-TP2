...
public class AccionMover{
	...
	public void moverUnidadTerrestre(Posicion posicionDestino, UnidadTerrestre unidad) {
	...
	public void moverUnidadAerea(Posicion posicionDestino, UnidadAerea unidad) {
